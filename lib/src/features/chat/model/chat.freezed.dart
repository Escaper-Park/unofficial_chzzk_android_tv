...
abstract class $ChatCopyWith<$Res> {
  ...
  @useResult
  $Res call({String nickname, String msg, Map<String, String>? emojis});
}
...
class _$ChatImpl implements _Chat {
  ...
  @override
  String toString() {
    return 'Chat(nickname: $nickname, msg: $msg, emojis: $emojis)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, nickname, msg, const DeepCollectionEquality().hash(_emojis));
...
abstract class _Chat implements Chat {
  factory _Chat(
      ...
      required final Map<String, String>? emojis}) = _$ChatImpl;
