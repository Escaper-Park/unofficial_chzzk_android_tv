...
void _useVodPlayerControllerLifecycle({
  ...
  required ControllerDisposalCoordinator controllerDisposalCoordinator,
  ...
  useEffect(
    () {
      ...
      unawaited(
        (() async {
          await controllerDisposalCoordinator.waitForPending();
          if (disposed) {
            return;
          }
      ...
      return () {
        ...
        unawaited(controllerDisposalCoordinator.schedule(controller.dispose));
      };
    },
    [
      controller,
