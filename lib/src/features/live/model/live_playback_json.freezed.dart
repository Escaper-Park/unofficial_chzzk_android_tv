...
class _$CdnInfoImpl implements _CdnInfo {
  const _$CdnInfoImpl({required this.cdnType});
  ...
  @override
  String toString() {
    return 'CdnInfo(cdnType: $cdnType)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, cdnType);
...
abstract class _CdnInfo implements CdnInfo {
  const factory _CdnInfo({required final String cdnType}) = _$CdnInfoImpl;
...
mixin _$EncodingTrack {
  ...
  String? get videoDynamicRange =>
      throw _privateConstructorUsedError; /* only KR with 720p, 1080p */
  String? get p2pPath => throw _privateConstructorUsedError;
  String? get p2pPathUrlEncoding => throw _privateConstructorUsedError;
  String? get path => throw _privateConstructorUsedError; /* audio only mode */
