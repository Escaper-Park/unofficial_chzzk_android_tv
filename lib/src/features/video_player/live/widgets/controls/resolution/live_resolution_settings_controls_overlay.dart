...
class LiveResolutionSettingsControlsOverlay extends ConsumerWidget {
  const LiveResolutionSettingsControlsOverlay({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final resolutionSettingItems = List.generate(
      livePlaylist.length,
      (index) => LiveResolutionControlItem(
        autofocus: index == 0,
        index: index,
...
class LiveResolutionControlItem extends HookConsumerWidget {
  const LiveResolutionControlItem({
    super.key,
